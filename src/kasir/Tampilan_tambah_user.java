 ...
 * @author miqda
 */
public class Tampilan_tambah_user extends javax.swing.JFrame {

    /**
     * Creates new form Tampilan_tambah_user
     */
    public Tampilan_tambah_user() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tampilan_tambah_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tampilan_tambah_user().setVisible(true);
            }
        });
    }
