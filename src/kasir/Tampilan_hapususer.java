 ...
 * @author miqda
 */
public class Tampilan_hapususer extends javax.swing.JFrame {

    /**
     * Creates new form Tampilan_tambah_user
     */
    public Tampilan_hapususer() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tampilan_hapususer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tampilan_hapususer().setVisible(true);
            }
        });
    }
